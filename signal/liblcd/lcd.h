...
void lcd_ts_id(void);
uint8_t lcd_ts_get_data(int *x, int *y, uint8_t *z);
...
//void lcd_draw_line(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t color, uint16_t width);
...
uint16_t lcd_draw_char(DC *dc, int x, int y, char c);
