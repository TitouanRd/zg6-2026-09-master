...
#define FC_GPIO_PORT			_GPIOB
#define FC_GPIO_PIN	    		PIN_0
#define FC_GPIO_CFG				PIN_MODE_INPUT|PIN_OPT_IRQ_EDGE_RISE

#define SOLENOID_GPIO_PORT		_GPIOB
#define SOLENOID_GPIO_PIN		PIN_10
#define SOLENOID_GPIO_CFG		PIN_MODE_OUTPUT|PIN_OPT_OUTPUT_SPEED_MEDIUM

#define SERVO_GPIO_PORT			_GPIOB
#define SERVO_GPIO_PIN			PIN_4
...
#define STDIR_GPIO_CFG			PIN_MODE_OUTPUT|PIN_OPT_OUTPUT_SPEED_MEDIUM

#define STEN_GPIO_PORT			_GPIOC
#define STEN_GPIO_PIN			PIN_7
#define STEN_GPIO_CFG			PIN_MODE_OUTPUT|PIN_OPT_OUTPUT_SPEED_MEDIUM
